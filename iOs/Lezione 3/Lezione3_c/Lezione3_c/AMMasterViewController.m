...
@interface AMMasterViewController () {
...
- (void)viewDidLoad
{
    ...
    self.detailViewController = (AMDetailViewController *)[[self.splitViewController.viewControllers lastObject] topViewController];
}
