...
public class ContactsProjectActivity extends Activity {
	...
	// Identifica la chiamata all'attivit� di scelta del contatto
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if(requestCode==CHOOSE_CONTACT_CODE){
			...
			// Si tratta dell'attivit� che avevamo invocato. Gestiamo quindi
			// i diversi casi
			...
			// E' arrivata una risposta da una attivit� diversa (impossibile in questo caso!)
